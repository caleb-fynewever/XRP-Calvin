...
public final class Constants {
  ...
  public static final class DrivetrainConstants {
    ...
    public static final double COUNTS_PER_MOTOR_SHAFT_REVOLUTION = 12.0;
    public static final double COUNTS_PER_REVOLUTION = COUNTS_PER_MOTOR_SHAFT_REVOLUTION * GEAR_RATIO; // 585.0
    public static final Distance WHEEL_DIAMETER = Inches.of(2.3622); // 60 mm
  }
